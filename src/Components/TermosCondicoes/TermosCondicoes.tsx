...
<p>
  <span style={{color: "rgb(68, 68, 68)"}}
    ...
    locais aplicáveis. Se você não concordar com algum desses termos, está
    proibido de usar ou acessar este site. Os materiais contidos neste site são
...
<p>
  <span style={{color: "rgb(68, 68, 68)"}}
    ...
    (informações ou software) no site Profreela , apenas para visualização
...
<ol>
  ...
  <li>
    <span style={{color: "rgb(68, 68, 68)"}}
      ...
      contido no site Profreela;&nbsp;</span
    >
  </li>
  <li>
    <span style={{color: "rgb(68, 68, 68)"}}
...
<p>
  <span style={{color: "rgb(68, 68, 68)"}}
    ...
    restrições e poderá ser rescindida por Profreela a qualquer momento. Ao
...
<ol>
  <li>
    <span style={{color: "rgb(68, 68, 68)"}}
      >Os materiais no site da Profreela são fornecidos 'como estão'. Profreela
  ...
  <li>
    <span style={{color: "rgb(68, 68, 68)"}}
      ...
      ou em sites vinculados a este site.</span
    >
  </li>
</ol>
...
<p>
  <span style={{color: "rgb(68, 68, 68)"}}
    ...
    de usar os materiais em Profreela, mesmo que Profreela ou um representante
    autorizado da Profreela tenha sido notificado oralmente ou por escrito da
...
<p>
  <span style={{color: "rgb(68, 68, 68)"}}
    >Os materiais exibidos no site da Profreela podem incluir erros técnicos,
    tipográficos ou fotográficos. Profreela não garante que qualquer material em
    seu site seja preciso, completo ou atual. Profreela pode fazer alterações
    nos materiais contidos em seu site a qualquer momento, sem aviso prévio. No
    entanto, Profreela não se compromete a atualizar os materiais.</span
  >
</p>
...
<p>
  <span style={{color: "rgb(68, 68, 68)"}}
    ...
    link não implica endosso por Profreela do site. O uso de qualquer site
...
<p>
  <span style={{color: "rgb(68, 68, 68)"}}
    ...
    vinculado à versão atual desses termos de serviço.</span
  >
</p>
...
<p>
  <span style={{color: "rgb(68, 68, 68)"}}
    ...
    do Profreela e você se submete irrevogavelmente à jurisdição exclusiva dos
