  ...
  return (
    <div>
      ...
      <p>
          ...
          <a className="text-purple-800" href="https://www.profreela.com">Profreela</a>, e outros sites que
      ...
      <ul className="pl-10">
        ...
        <li>
          ...
          <span>
            <a className="text-purple-800" href="https://betnacionalbrasil.br.com">Bet Nacional</a> ou azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;
          </span>
        </li>
        <li>
          <span>
      ...
      <p>
          Esta política é efetiva a partir de&nbsp;13 August 2024 14:54
      </p>
      </div>
      <Footer id="contato" />
    </div>
