...
<p>
  <span style={{color: "rgb(68, 68, 68)"}}
    >A sua privacidade é importante para nós. É política do Profreela respeitar
    a sua privacidade em relação a qualquer informação sua que possamos coletar
    no site <a href="https://www.profreela.com">Profreela</a>, e outros sites
    que possuímos e operamos.</span
  >
</p>
<p>
  <span style={{color: "rgb(68, 68, 68)"}}
    ...
    ><ul>
      ...
      <li>
        <span style={{color: "rgb(68, 68, 68)"}}
          ...
          fornecê-lo para fazer uma compra.</span
        >
      </li>
    </ul>
    <p><br /></p
...
<p>
  <span style={{color: "rgb(68, 68, 68)"}}
    ...
    que o Profreela oferece no site e com caráter enunciativo, mas não
    limitativo:</span
  >
</p>
<ul>
...
<p>
  <span style={{color: "rgb(68, 68, 68)"}}
    >Esta política é efetiva a partir de&nbsp;13 August 2024 14:54</span
  >
</p>
    </>
  )
